(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".jsServicesSlider")) {
            new core(".jsServicesSlider", {
                ...
                navigation: {
                    prevEl: ".navigation-slider_left",
                    nextEl: ".navigation-slider_right"
                },
                breakpoints: {
                    991.98: {
                        slidesPerView: 3,
        ...
        if (document.querySelector(".jsSolutionsSlider")) {
            new core(".jsSolutionsSlider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.2,
        ...
        if (document.querySelector(".jsPartnersMainSlider")) {
            new core(".jsPartnersMainSlider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.2,
                ...
                slidesPerGroup: 1,
                pagination: {
                    el: ".slider-partners-main__pagination",
                    clickable: true
                },
                breakpoints: {
                    991.98: {
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            if (scrollTop >= startPoint) {
                !header.classList.contains("_header-scroll") && !header.classList.contains("_submenu-open") ? header.classList.add("_header-scroll") : null;
                if (headerShow) {
                    if (scrollTop > scrollDirection) header.classList.contains("_header-show") && !header.classList.contains("_submenu-open") ? header.classList.remove("_header-show") : null; else !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null;
                    timer = setTimeout((() => {
    ...
    document.addEventListener("DOMContentLoaded", (function(e) {
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest(".jsLinkFlip")) {
                const parent = targetElement.closest(".item-main-service") || targetElement.closest(".slide-partners-main") || targetElement.closest(".slide-solution");
                parent.classList.toggle("_open-card");
            }
        }
        ...
        const tabIcon = document.querySelector(".tabs-industry__icon");
        if (tabIcon) {
            const tabActiveTitle = document.querySelector(".tabs-industry__title._tab-active");
            const halfHeightBlock = tabActiveTitle.scrollHeight / 2;
